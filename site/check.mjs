...
function loadScript(source, filename, globalName) {
  const context = { window: {}, TextDecoder, TextEncoder, btoa, atob, URL, Uint8Array, ArrayBuffer };
...
run("feature article inventory covers every embedded feature", () => {
  ...
  "browser-extension", "local-totp-core", "progress-window", "in-app-documentation-browser", "file-converter", "personal-vocabulary", "site-foundation"
]);
