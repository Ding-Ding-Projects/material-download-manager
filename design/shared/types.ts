...
export const IPC = {
  ...
  OLLAMA_REFRESH_CATALOG_CAPABILITY: "ollama:refreshCatalogCapability",
  OLLAMA_REFRESH_MODEL_DETAILS: "ollama:refreshModelDetails",
  OLLAMA_PROBE_HARDWARE: "ollama:probeHardware",
  OLLAMA_START_PULL_BATCH: "ollama:startPullBatch",
  OLLAMA_RETRY_PULL_BATCH: "ollama:retryPullBatch",
  OLLAMA_CANCEL_PULL_BATCH: "ollama:cancelPullBatch",
  OLLAMA_DELETE_MODEL: "ollama:deleteModel",
  OLLAMA_COPY_MODEL: "ollama:copyModel",
  OLLAMA_GENERATE: "ollama:generate",
  OLLAMA_CREATE_CHAT: "ollama:createChat",
  OLLAMA_RENAME_CHAT: "ollama:renameChat",
  OLLAMA_DELETE_CHAT: "ollama:deleteChat",
  OLLAMA_SEND_CHAT: "ollama:sendChat",
  OLLAMA_CANCEL_CHAT: "ollama:cancelChat",
  OLLAMA_EXPORT_CHAT: "ollama:exportChat",
  OLLAMA_REGISTER_HARNESS: "ollama:registerHarness",
  OLLAMA_PICK_HARNESS_EXECUTABLE: "ollama:pickHarnessExecutable",
  OLLAMA_PICK_HARNESS_FOLDER: "ollama:pickHarnessFolder",
  OLLAMA_REMOVE_HARNESS: "ollama:removeHarness",
  OLLAMA_PREFLIGHT_HARNESS: "ollama:preflightHarness",
  OLLAMA_LAUNCH_HARNESS: "ollama:launchHarness",
  OLLAMA_RESTORE_HARNESS: "ollama:restoreHarness",
  OLLAMA_STATE_CHANGED: "ollama:stateChanged",
