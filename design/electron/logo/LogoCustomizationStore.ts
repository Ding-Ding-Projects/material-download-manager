...
export class LogoCustomizationStore {
  ...
  async commitClear(prepared: PreparedLogoClear): Promise<void> {
    ...
    try {
      ...
      // The preset setting has already committed at this point. Leaving an
      // unreachable, opaque backup is safer than rolling the setting back to
      // a custom logo whose cache may have been only partially removed.
    }
  }
