...
import type { OllamaSuiteState } from "@shared/ollama";
...
export interface MaterialDownloadManagerAPI {
  ...
  onOllamaSuiteStateChanged(cb: (state: OllamaSuiteState) => void): () => void;
  ...
  refreshOllamaProvider(id: string): Promise<OllamaSuiteState>;
  refreshOllamaCatalogCapability(): Promise<OllamaSuiteState>;
  refreshOllamaModelDetails(providerId: string, modelName: string): Promise<OllamaSuiteState>;
  probeOllamaHardware(): Promise<OllamaSuiteState>;
  startOllamaPullBatch(input: unknown): Promise<OllamaSuiteState>;
  retryOllamaPullBatch(id: string): Promise<OllamaSuiteState>;
  cancelOllamaPullBatch(id: string): Promise<OllamaSuiteState>;
  deleteOllamaModel(providerId: string, modelName: string): Promise<OllamaSuiteState>;
  copyOllamaModel(providerId: string, input: unknown): Promise<OllamaSuiteState>;
  generateOllama(input: unknown): Promise<OllamaSuiteState>;
  createOllamaChat(input: unknown): Promise<OllamaSuiteState>;
  renameOllamaChat(id: string, name: string): Promise<OllamaSuiteState>;
  deleteOllamaChat(id: string): Promise<OllamaSuiteState>;
  sendOllamaChat(input: unknown): Promise<OllamaSuiteState>;
  cancelOllamaChat(id: string): Promise<OllamaSuiteState>;
  exportOllamaChat(id: string, format: ExportFormat): Promise<ExportResult>;
  registerOllamaHarness(input: unknown): Promise<OllamaSuiteState>;
  pickOllamaHarnessExecutable(): Promise<string | null>;
  pickOllamaHarnessFolder(): Promise<string | null>;
  removeOllamaHarness(id: string): Promise<OllamaSuiteState>;
  preflightOllamaHarness(input: unknown): Promise<OllamaSuiteState>;
  launchOllamaHarness(input: unknown): Promise<OllamaSuiteState>;
  restoreOllamaHarness(id: string): Promise<OllamaSuiteState>;
